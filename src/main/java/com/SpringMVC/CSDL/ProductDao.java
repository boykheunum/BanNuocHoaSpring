...
public class ProductDao implements ProductInterface {
  ...
  public int AddProduct(Products productsModel) {
    ...
    sqlString =
        "INSERT INTO `products`(`nameproduct`, `imageproduct`, `price`, `importprice`, `quantity`, `descriotion`, `id_type_product`) VALUES (?,?,?,?,?,?,?)";
  ...
  public int DeleteProduct(int idProduct) {
    // TODO Auto-generated method stub
    sqlString = "DELETE FROM `products` WHERE id_product = ? ";
    jdbcTemplate.update(sqlString, new Object[] {idProduct});
    return 1;
  }
  ...
  public int EditProduct(int idProduct, Products productsModel) {
    // TODO Auto-generated method stub
    String sqString =
        "UPDATE `products` SET `nameproduct`=?,`imageproduct`=?,`price`=?,`importprice`=?,`quantity`=?,`descriotion`=?,`id_type_product`=? WHERE `id_product`=?";
  ...
  public Products SearchProductById(int idProduct, Products productsModel) {
    ...
    productsModel =
        jdbcTemplate.queryForObject(sqlString, new Object[] {idProduct}, new ProductMapper());
    return productsModel;

  }

  @Override
  public int DeleteProductByTypeId(int idTypeProduct) {
    // TODO Auto-generated method stub
    sqlString = "DELETE FROM `products` WHERE   id_type_product = ? ";
    jdbcTemplate.update(sqlString, new Object[] {idTypeProduct});
    return 1;
  }
}
